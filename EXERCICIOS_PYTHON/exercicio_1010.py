...
codigo1, quantidade1, valarUnitario1 = input().split()
codigo2, quantidade2, valarUnitario2 = input().split()

total = (int(quantidade1) * float(valarUnitario1)) + (int(quantidade2) * float(valarUnitario2))
